...
namespace ONE.Admin.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpDataItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataTargetName = table.Column<string>(type: "text", nullable: true),
                    HideDataTargetFields = table.Column<string>(type: "text", nullable: true),
                    HideDataTargetFieldDisplayNames = table.Column<string>(type: "text", nullable: true),
                    Condition = table.Column<string>(type: "text", nullable: true),
                    DataOperation = table.Column<int>(type: "integer", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpDataRules", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpDataTargets", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpFileRecords", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuCode = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpSaleVersions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AppName = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    AppVersion = table.Column<string>(type: "text", nullable: true),
                    AppCode = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    AppSecret = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    AppUrl = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpSysApps", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFrame = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    SysAppId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpSysMenus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactWay = table.Column<string>(type: "text", nullable: true),
                    ExpirationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    SaleVersionId = table.Column<Guid>(type: "uuid", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "AbpUserDataRules",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DataTargetName = table.Column<string>(type: "text", nullable: true),
                    UserRuleId = table.Column<Guid>(type: "uuid", nullable: false),
                    DataRuleId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpUserDataRules", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpUserRules", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppOrderDemos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AbpDataTargetFields",
                columns: table => new
                {
                    DataTargetName = table.Column<string>(type: "text", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpDataTargetFields", x => new { x.DataTargetName, x.Name });
                    table.ForeignKey(
                        name: "FK_AbpDataTargetFields_AbpDataTargets_DataTargetName",
                        column: x => x.DataTargetName,
                        principalTable: "AbpDataTargets",
            ...
            migrationBuilder.CreateTable(
                name: "AbpSaleVersionMenus",
                columns: table => new
                {
                    SaleVersonId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpSaleVersionMenus", x => new { x.SaleVersonId, x.MenuCode });
                    table.ForeignKey(
                        name: "FK_AbpSaleVersionMenus_AbpSaleVersions_SaleVersionId",
                        column: x => x.SaleVersionId,
                        principalTable: "AbpSaleVersions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpFileRecords_CreationTime",
                table: "AbpFileRecords",
                column: "CreationTime");

            migrationBuilder.CreateIndex(
                name: "IX_AbpFileRecords_FileName",
                table: "AbpFileRecords",
                column: "FileName");

            migrationBuilder.CreateIndex(
                name: "IX_AbpFileRecords_OriginalFileName",
                table: "AbpFileRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpRoleMenus_AppId",
                table: "AbpRoleMenus",
                column: "AppId");

            migrationBuilder.CreateIndex(
                name: "IX_AbpRoleMenus_MenuCode",
                table: "AbpRoleMenus",
                column: "MenuCode");

            migrationBuilder.CreateIndex(
                name: "IX_AbpRoleMenus_Role",
                table: "AbpRoleMenus",
                column: "Role");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpSaleVersionMenus_SaleVersionId",
                table: "AbpSaleVersionMenus",
                column: "SaleVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_AbpSaleVersions_Name",
                table: "AbpSaleVersions",
                column: "Name");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpSysApps_AppCode",
                table: "AbpSysApps",
                column: "AppCode");

            migrationBuilder.CreateIndex(
                name: "IX_AbpSysApps_AppName",
                table: "AbpSysApps",
                column: "AppName");

            migrationBuilder.CreateIndex(
                name: "IX_AbpSysMenus_Code",
                table: "AbpSysMenus",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_AbpSysMenus_ParentCode",
                table: "AbpSysMenus",
                column: "ParentCode");
