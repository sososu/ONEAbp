...
namespace ONE.Admin.Settings
{
    ...
    public class FileSettingAppService : AdminAppService, IFileSettingAppService
    {
        ...
        public async Task<FileSettingDto> GetAsync()
        {
            ...
            //{
            //    settingsDto.LimitSize = Convert.ToInt64(await SettingManager.GetOrNullForTenantAsync(FileManagementSettings.LimitSizeSettingName, CurrentTenant.GetId(), false));
            //    settingsDto.TotalLimitSize = Convert.ToInt64(await SettingManager.GetOrNullForTenantAsync(FileManagementSettings.TotalLimitSizeSettingName, CurrentTenant.GetId(), false));
            //    settingsDto.SupportMimeType = await SettingManager.GetOrNullForTenantAsync(FileManagementSettings.SupportMimeType, CurrentTenant.GetId(), false);
            //}
