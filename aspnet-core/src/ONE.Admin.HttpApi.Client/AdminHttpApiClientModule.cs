...
[DependsOn(typeof(AbpSysResourceHttpApiClientModule))]
    [DependsOn(typeof(AbpDataDictionaryHttpApiClientModule))]
    [DependsOn(typeof(AbpDataPermissionHttpApiClientModule))]
