    ...
    public static void ConfigureIdentity([NotNull] this ModelBuilder builder)
    {
        ...
        builder.Entity<IdentityUser>(b =>
        {
            ...
            b.Property(u => u.Avatar)
             .HasMaxLength(IdentityUserConsts.MaxUrlLength)
             .HasColumnName(nameof(IdentityUser.Avatar));

            b.Property(u => u.Sex).HasDefaultValue(Sex.Unkonw)
              .HasColumnName(nameof(IdentityUser.Sex));
