...
public class IdentityPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        usersPermission.AddChild(IdentityPermissions.Users.ResetPassword, L("Permission:ResetPassword"));
        usersPermission.AddChild(IdentityPermissions.Users.ManagePermissions, L("Permission:ChangePermissions"));


        var organizationsUnitPermission = identityGroup.AddPermission(IdentityPermissions.OrganizationUnit.Default, L("Permission:UserManagement"));
        organizationsUnitPermission.AddChild(IdentityPermissions.OrganizationUnit.Create, L("Permission:Create"));
        organizationsUnitPermission.AddChild(IdentityPermissions.OrganizationUnit.Update, L("Permission:Edit"));
        organizationsUnitPermission.AddChild(IdentityPermissions.OrganizationUnit.Delete, L("Permission:Delete"));
