...
[DependsOn(
    ...
    typeof(AbpAspNetCoreMvcClientModule), /*Remote call permissions, Settings, features, access to tenant information, etc*/
    typeof(AbpHttpClientIdentityModelWebModule) /*Invoke the remote service using the current logged-in user Token*/
)]
