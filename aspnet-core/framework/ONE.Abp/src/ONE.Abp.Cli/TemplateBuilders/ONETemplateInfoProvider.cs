...
namespace TemplateBuilders
{
    ...
    public class ONETemplateInfoProvider : ITemplateInfoProvider, ITransientDependency
    {
        ...
        public ONETemplateInfoProvider(ICancellationTokenProvider cancellationTokenProvider,
        ...
        public async Task<TemplateInfo> GetDefaultAsync()
        {
            ...
            return Get(OneAppTemplate.TemplateName);
        }
        ...
        public TemplateInfo Get(string name)
        {
            switch (name)
            {
                case OneAppTemplate.TemplateName:
                    return new OneAppTemplate();
                case MicroTemplate.TemplateName:
                    return new MicroTemplate();
